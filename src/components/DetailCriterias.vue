  ...
  <div class="criteria-detail">
    ...
    <div class="content mt-4">
      <h4 style="text-align: left">
        <strong>Tiêu đề:</strong> {{ criteriaDetail.title }}
      </h4>
      <h4 style="text-align: left" class="mb-3">
        <strong>Số điểm:</strong> {{ criteriaDetail.point }}
      </h4>
          ...
          <tbody>
            ...
            >
              ...
              <td>
                ...
                <a type="button" class="btn btn-warning me-2">Sửa</a>
      ...
      <div v-else>
        <p>Không có câu hỏi nào cho tiêu chí này.</p>
      </div>
...
export default {
  ...
  computed: {
    totalPages() {
    if (this.criteriaDetail.questions && Array.isArray(this.criteriaDetail.questions)) {
      return Math.ceil(this.criteriaDetail.questions.length / this.itemsPerPage);
    }
    return 1;
  },
